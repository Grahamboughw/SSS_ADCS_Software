...
# Plot magnetic field
plt.plot(tout, BxBout, color='b', linewidth=2, label='X')
plt.plot(tout, ByBout, color='g', linewidth=2, label='Y')
plt.plot(tout, BzBout, color='r', linewidth=2, label='Z')
plt.xlabel('Time (sec)')
...
plt.plot(tout/period, pqrout[0], color='b', linewidth=2, label='Roll Rate')
plt.plot(tout/period, pqrout[1], color='g', linewidth=2, label='Pitch Rate')
plt.plot(tout/period, pqrout[2], color='r', linewidth=2, label='Yaw Rate')
